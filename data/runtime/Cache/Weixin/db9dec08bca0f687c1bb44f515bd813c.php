...
<body>
	<div class="wrap">
		<ul class="nav nav-tabs">
			...
			<li class="active"><a href="<?php echo U('Indexadmin/add_imgs');?>" target="_self">添加图文回复</a></li>
		</ul>
		<form method="post" class="form-horizontal js-ajax-form" action="<?php echo U('Weixin/Indexadmin/add_imgs_post');?>">
			<fieldset>
				...
				<div class="control-group">
					...
					<div class="controls">
						<input type="text" name="url" required placeholder="请输入链接地址">
						<span class="form-required">*</span>
					</div>
				</div>
				<div class="control-group">
				...
				<div class="control-group">
					...
					<div class="controls">
						<textarea class="form-control" rows="5" name="description" required style="width: 420px"></textarea>
						<span class="form-required">*</span>
					</div>
				</div>
			</fieldset>
