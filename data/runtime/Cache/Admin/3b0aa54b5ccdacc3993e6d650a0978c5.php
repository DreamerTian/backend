				...
				<div class="span9">
					<table class="table table-bordered">
						<tr>
							<th width="80">栏目</th>
							<td class="txt-l">
								<select name="term[]"><?php echo ($taxonomys); ?></select>
							</td>
						</tr>
						<tr>
							<th>标题</th>
							<td class="txt-l">
								<input type="text" name="post[post_title]" id="title" required value="" placeholder="请输入标题"/>
								<span class="form-required">*</span>
							</td>
						</tr>
						<tr>
							<th>关键词</th>
							<td class="txt-l"><input type="text" name="post[post_keywords]" id="keywords" value="" placeholder="请输入关键字"> 多关键词之间用空格或者英文逗号隔开</td>
						</tr>
						<tr>
							<th>文章来源</th>
							<td class="txt-l"><input type="text" name="post[post_source]" id="source" value=""  placeholder="请输入文章来源"></td>
						</tr>
						<tr>
							<th>摘要</th>
							<td class="txt-l">
								<textarea name="post[post_excerpt]" id="description" required placeholder="请填写摘要"></textarea>
							</td>
						</tr>
						<tr>
							<th>内容</th>
