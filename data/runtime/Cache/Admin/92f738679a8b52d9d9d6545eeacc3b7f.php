...
<meta charset="utf-8">
<title>后台管理系统 <?php echo L('ADMIN_CENTER');?></title>
		...
		<div class="navbar-inner">
			<div class="container-fluid">
				...
				<img src="/admin/themes/simplebootx/Public/assets/images/logo-18.png">
					<b>后台管理系统</b> <?php echo L('ADMIN_CENTER');?>
				</small>
				</a>
				<div class="pull-left nav_shortcuts" >

					<a class="btn btn-small btn-warning" href="<?php echo U('index/index');?>" title="<?php echo L('WEBSITE_HOME_PAGE');?>">
						<i class="fa fa-home"></i>
					</a>
					<?php if(sp_auth_check(sp_get_current_admin_id(),'portal/AdminPost/index')): ?><a class="btn btn-small btn-info" href="javascript:openapp('<?php echo U('Admin/Article/add');?>','index_postlist','<?php echo L('文章管理');?>');" title="文章管理">
				...
				<!-- <div class="pull-left nav_shortcuts" >
					...
					<?php if(sp_auth_check(sp_get_current_admin_id(),'portal/AdminPost/index')): ?><a class="btn btn-small btn-info" href="javascript:openapp('<?php echo U('Admin/Article/index');?>','index_postlist','<?php echo L('文章管理');?>');" title="文章管理">
						<i class="fa fa-pencil"></i>
					</a><?php endif; ?>
