...
<body>
	<div class="wrap js-check-wrap">
		...
		<form action="<?php echo U('Article/edit_post');?>" method="post" class="form-horizontal js-ajax-forms" enctype="multipart/form-data">
			<div class="row-fluid">
				<div class="span9">
					<table class="table table-bordered">
						<tr>
							<th width="80">栏目</th>
							<td class="txt-l">
								<select style="max-height: 100px;"name="term[]"><?php echo ($taxonomys); ?></select>
						...
						<tr>
							...
							<td class="txt-l">
								...
								<input type="text" name="post[post_title]" required value="<?php echo ($post["post_title"]); ?>" placeholder="请输入标题"/>
						...
						<tr>
							<th>关键词</th>
							<td class="txt-l">
								<input type="text" name="post[post_keywords]" value="<?php echo ($post['post_keywords']); ?>" placeholder="请输入关键字">
								多关键词之间用空格或者英文逗号隔开
							</td>
						</tr>
						...
						<tr>
							<th>文章来源</th>
							<td class="txt-l">
								<input type="text" name="post[post_source]" value="<?php echo ($post['post_source']); ?>" placeholder="请输入文章来源">
							</td>
						</tr>
						<tr>
							<th>摘要</th>
							<td class="txt-l">
								<textarea name="post[post_excerpt]" required placeholder="请填写摘要"><?php echo ($post["post_excerpt"]); ?></textarea>
								<span class="form-required">*</span>
							</td>
						</tr>
						<tr>
			...
			<div class="form-actions">
				...
				<a class="btn" href="<?php echo U('Article/index');?>">返回</a>
			</div>
		</form>
	</div>
									...
									Wind.use("artDialog", function() {
										art.dialog({
											...
											button : [ {
												...
												name : '返回列表页',
												callback : function() {
													location = "<?php echo U('Article/index');?>";
													return true;
												}
											} ]
										});
