...
class Easemob{
	...
	//环信参数
	private $client_id='YXA62dC-oHPlEeaq-FEJFLdVzg';
	private $client_secret='YXA66o8M7ED2Q3B4RZgpOdVa2t6cMAQ';
	private $org_name='tt232221';
	private $app_name='bornbaby';
	private $url;
//------------------------------------------------------用户体系	
		/**
	 * 初始化参数
